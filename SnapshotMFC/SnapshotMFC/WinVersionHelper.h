...
static const OSVERSIONINFOEX &GetWindowsVersion()
{
    ...
    if (osvi.dwOSVersionInfoSize == 0)
    {
        ...
        RtlGetVersionFunctor RtlGetVersion = (RtlGetVersionFunctor)(::GetProcAddress(
        ...
        GetNtVersionNumbersFunctor GetNtVersionNumbers
            = (GetNtVersionNumbersFunctor)(::GetProcAddress(::GetModuleHandle(L"ntdll.dll"),
        ...
        if (bGetNtVersionNumbers)
        {
            ...
            g_osver_info.bCompatMode
                = (osvi.dwMajorVersion != g_osver_info.dwMajorVersion
