...
BEGIN_MESSAGE_MAP(CmymagsampleApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CmymagsampleApp construction

CmymagsampleApp::CmymagsampleApp()
{
...
// The one and only CmymagsampleApp object

CmymagsampleApp theApp;


// CmymagsampleApp initialization

BOOL CmymagsampleApp::InitInstance()
{
